...
public class DeviceItems {
    ...
    public static final RegistrySupplier<BlockItem> ORANGE_PRINTER = REGISTER.register(Devices.id("orange_printer"), () -> new ColoredDeviceItem(DeviceBlocks.ORANGE_PRINTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.ORANGE, ModDeviceTypes.PRINTER));
    public static final RegistrySupplier<BlockItem> MAGENTA_PRINTER = REGISTER.register(Devices.id("magenta_printer"), () -> new ColoredDeviceItem(DeviceBlocks.MAGENTA_PRINTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.MAGENTA, ModDeviceTypes.PRINTER));
    public static final RegistrySupplier<BlockItem> LIGHT_BLUE_PRINTER = REGISTER.register(Devices.id("light_blue_printer"), () -> new ColoredDeviceItem(DeviceBlocks.LIGHT_BLUE_PRINTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.LIGHT_BLUE, ModDeviceTypes.PRINTER));
    public static final RegistrySupplier<BlockItem> YELLOW_PRINTER = REGISTER.register(Devices.id("yellow_printer"), () -> new ColoredDeviceItem(DeviceBlocks.YELLOW_PRINTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.YELLOW, ModDeviceTypes.PRINTER));
    public static final RegistrySupplier<BlockItem> LIME_PRINTER = REGISTER.register(Devices.id("lime_printer"), () -> new ColoredDeviceItem(DeviceBlocks.LIME_PRINTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.LIME, ModDeviceTypes.PRINTER));
    public static final RegistrySupplier<BlockItem> PINK_PRINTER = REGISTER.register(Devices.id("pink_printer"), () -> new ColoredDeviceItem(DeviceBlocks.PINK_PRINTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.PINK, ModDeviceTypes.PRINTER));
    public static final RegistrySupplier<BlockItem> GRAY_PRINTER = REGISTER.register(Devices.id("gray_printer"), () -> new ColoredDeviceItem(DeviceBlocks.GRAY_PRINTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.GRAY, ModDeviceTypes.PRINTER));
    public static final RegistrySupplier<BlockItem> LIGHT_GRAY_PRINTER = REGISTER.register(Devices.id("light_gray_printer"), () -> new ColoredDeviceItem(DeviceBlocks.LIGHT_GRAY_PRINTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.LIGHT_GRAY, ModDeviceTypes.PRINTER));
    public static final RegistrySupplier<BlockItem> CYAN_PRINTER = REGISTER.register(Devices.id("cyan_printer"), () -> new ColoredDeviceItem(DeviceBlocks.CYAN_PRINTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.CYAN, ModDeviceTypes.PRINTER));
    public static final RegistrySupplier<BlockItem> PURPLE_PRINTER = REGISTER.register(Devices.id("purple_printer"), () -> new ColoredDeviceItem(DeviceBlocks.PURPLE_PRINTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.PURPLE, ModDeviceTypes.PRINTER));
    public static final RegistrySupplier<BlockItem> BLUE_PRINTER = REGISTER.register(Devices.id("blue_printer"), () -> new ColoredDeviceItem(DeviceBlocks.BLUE_PRINTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.BLUE, ModDeviceTypes.PRINTER));
    public static final RegistrySupplier<BlockItem> BROWN_PRINTER = REGISTER.register(Devices.id("brown_printer"), () -> new ColoredDeviceItem(DeviceBlocks.BROWN_PRINTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.BROWN, ModDeviceTypes.PRINTER));
    public static final RegistrySupplier<BlockItem> GREEN_PRINTER = REGISTER.register(Devices.id("green_printer"), () -> new ColoredDeviceItem(DeviceBlocks.GREEN_PRINTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.GREEN, ModDeviceTypes.PRINTER));
    public static final RegistrySupplier<BlockItem> RED_PRINTER = REGISTER.register(Devices.id("red_printer"), () -> new ColoredDeviceItem(DeviceBlocks.RED_PRINTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.RED, ModDeviceTypes.PRINTER));
    public static final RegistrySupplier<BlockItem> BLACK_PRINTER = REGISTER.register(Devices.id("black_printer"), () -> new ColoredDeviceItem(DeviceBlocks.BLACK_PRINTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.BLACK, ModDeviceTypes.PRINTER));

    // Routers
    public static final RegistrySupplier<BlockItem> WHITE_ROUTER = REGISTER.register(Devices.id("white_router"), () -> new ColoredDeviceItem(DeviceBlocks.WHITE_ROUTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.WHITE, ModDeviceTypes.ROUTER));
    public static final RegistrySupplier<BlockItem> ORANGE_ROUTER = REGISTER.register(Devices.id("orange_router"), () -> new ColoredDeviceItem(DeviceBlocks.ORANGE_ROUTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.ORANGE, ModDeviceTypes.ROUTER));
    public static final RegistrySupplier<BlockItem> MAGENTA_ROUTER = REGISTER.register(Devices.id("magenta_router"), () -> new ColoredDeviceItem(DeviceBlocks.MAGENTA_ROUTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.MAGENTA, ModDeviceTypes.ROUTER));
    public static final RegistrySupplier<BlockItem> LIGHT_BLUE_ROUTER = REGISTER.register(Devices.id("light_blue_router"), () -> new ColoredDeviceItem(DeviceBlocks.LIGHT_BLUE_ROUTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.LIGHT_BLUE, ModDeviceTypes.ROUTER));
    public static final RegistrySupplier<BlockItem> YELLOW_ROUTER = REGISTER.register(Devices.id("yellow_router"), () -> new ColoredDeviceItem(DeviceBlocks.YELLOW_ROUTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.YELLOW, ModDeviceTypes.ROUTER));
    public static final RegistrySupplier<BlockItem> LIME_ROUTER = REGISTER.register(Devices.id("lime_router"), () -> new ColoredDeviceItem(DeviceBlocks.LIME_ROUTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.LIME, ModDeviceTypes.ROUTER));
    public static final RegistrySupplier<BlockItem> PINK_ROUTER = REGISTER.register(Devices.id("pink_router"), () -> new ColoredDeviceItem(DeviceBlocks.PINK_ROUTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.PINK, ModDeviceTypes.ROUTER));
    public static final RegistrySupplier<BlockItem> GRAY_ROUTER = REGISTER.register(Devices.id("gray_router"), () -> new ColoredDeviceItem(DeviceBlocks.GRAY_ROUTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.GRAY, ModDeviceTypes.ROUTER));
    public static final RegistrySupplier<BlockItem> LIGHT_GRAY_ROUTER = REGISTER.register(Devices.id("light_gray_router"), () -> new ColoredDeviceItem(DeviceBlocks.LIGHT_GRAY_ROUTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.LIGHT_GRAY, ModDeviceTypes.ROUTER));
    public static final RegistrySupplier<BlockItem> CYAN_ROUTER = REGISTER.register(Devices.id("cyan_router"), () -> new ColoredDeviceItem(DeviceBlocks.CYAN_ROUTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.CYAN, ModDeviceTypes.ROUTER));
    public static final RegistrySupplier<BlockItem> PURPLE_ROUTER = REGISTER.register(Devices.id("purple_router"), () -> new ColoredDeviceItem(DeviceBlocks.PURPLE_ROUTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.PURPLE, ModDeviceTypes.ROUTER));
    public static final RegistrySupplier<BlockItem> BLUE_ROUTER = REGISTER.register(Devices.id("blue_router"), () -> new ColoredDeviceItem(DeviceBlocks.BLUE_ROUTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.BLUE, ModDeviceTypes.ROUTER));
    public static final RegistrySupplier<BlockItem> BROWN_ROUTER = REGISTER.register(Devices.id("brown_router"), () -> new ColoredDeviceItem(DeviceBlocks.BROWN_ROUTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.BROWN, ModDeviceTypes.ROUTER));
    public static final RegistrySupplier<BlockItem> GREEN_ROUTER = REGISTER.register(Devices.id("green_router"), () -> new ColoredDeviceItem(DeviceBlocks.GREEN_ROUTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.GREEN, ModDeviceTypes.ROUTER));
    public static final RegistrySupplier<BlockItem> RED_ROUTER = REGISTER.register(Devices.id("red_router"), () -> new ColoredDeviceItem(DeviceBlocks.RED_ROUTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.RED, ModDeviceTypes.ROUTER));
    public static final RegistrySupplier<BlockItem> BLACK_ROUTER = REGISTER.register(Devices.id("black_router"), () -> new ColoredDeviceItem(DeviceBlocks.BLACK_ROUTER.get(), new Item.Properties().tab(Devices.TAB_DEVICE), DyeColor.BLACK, ModDeviceTypes.ROUTER));
