...
public class ItemList<E> extends Component implements Iterable<E> {
    ...
    protected com.ultreon.devices.api.app.component.Button btnUp;
    protected com.ultreon.devices.api.app.component.Button btnDown;
    ...
    public void init(Layout layout) {
        btnUp = new com.ultreon.devices.api.app.component.Button(left + width - 12, top, Icons.CHEVRON_UP);
        ...
        if (this.visible) {
            ...
            if (item != null) {
                if (renderer != null) {
                    ...
                    fill(pose, xPosition + 1, yPosition + (i * 14) + 1, xPosition + width - 1, yPosition + 13 + (i * 14) + 1, (i + offset) != selected ? bgColor.brighter().getRGB() : bgColor.brighter().brighter().getRGB());
                    drawString(pose, Laptop.font, item.toString(), xPosition + 3, yPosition + 3 + (i * 14), textColor);
                }
            }
