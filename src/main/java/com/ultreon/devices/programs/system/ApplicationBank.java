...
//                RenderSystem.setShaderTexture(villagerTextures);
        ...
        amountField = new com.ultreon.devices.api.app.component.TextField(5, 45, 110);
        ...
        buttonDeposit.setClickListener((mouseX, mouseY, mouseButton) -> {
            if (mouseButton == 0) {
                ...
                try {
                    ...
                    amountField.setText("0");
                    openDialog(new com.ultreon.devices.api.app.Dialog.Message("Invalid amount. The maximum that you can deposit is " + Integer.MAX_VALUE));
                }
            }
        });
