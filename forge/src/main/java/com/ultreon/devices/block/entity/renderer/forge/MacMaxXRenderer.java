package com.ultreon.devices.block.entity.renderer.forge;
...
public class MacMaxXRenderer extends GeoBlockRenderer<MacMaxXBlockEntity> {
    public MacMaxXRenderer(BlockEntityRendererProvider.Context context) {
        super(context, new MacMaxXModel());
    }
}